...
<main>
    <div class="content" id="content">
        ...
        <div class="ott-options">
            <div class="ott-option" onclick="location.href='subscribe/netflix.php'">
                <img src="images/netflix-logo.png" alt="Netflix">
                <h3>Netflix</h3>
            </div>
            <div class="ott-option" onclick="location.href='subscribe/amazon.php'">
                <img src="images/prime-logo.png" alt="Prime Video">
                <h3>Prime Video</h3>
            </div>
            <div class="ott-option" onclick="location.href='subscribe/hotstar.php'">
                <img src="images/hotstar-logo.png" alt="Hotstar">
                <h3>Hotstar</h3>
            </div>
            <div class="ott-option" onclick="location.href='subscribe/youtube.php'">
                <img src="images/youtube-logo.png" alt="Youtube">
                <h3>Youtube Premium</h3>
            </div>
            <div class="ott-option" onclick="location.href='subscribe/spotify.php'">
                <img src="images/spotify-logo.png" alt="Spotify">
                <h3>Spotify</h3>
            </div>
            <div class="ott-option" onclick="location.href='subscribe/underconstruction.php'">
