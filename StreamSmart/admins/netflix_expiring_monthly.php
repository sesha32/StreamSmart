...
<head>
    ...
    <title>Expiring Soon - Monthly Plan</title>
    <style>
        body {
        ...
        table {
            ...
            margin-top: 20px;
            background-color: #282828; /* Dark Netflix background */
        }
        th, td {
            padding: 12px;
            text-align: center;
        ...
        th {
            background-color: #e50914; /* Netflix red for table headers */
            color: #fff;
            font-weight: bold;
            font-size: 1.1em;
        }
        ...
        tr:nth-child(even) td {
            background-color: #282828; /* Slightly darker for alternating rows */
        }
        .back-button {
...
<body>
    ...
    <div class="container">
        <h1>Expiring Soon - Monthly Plan</h1>
