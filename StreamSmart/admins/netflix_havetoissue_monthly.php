...
$query = "SELECT subscription_id, user_id, first_name, email, mobile, subscription_date FROM netflix_subscriptions WHERE plan='monthly' AND issued='no'";
...
<body>
    ...
    <div class="container">
        <h1>Netflix Subscriptions - Monthly Plan</h1>
        <?php
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <form action='delete_netmonsubscription.php' method='POST' style='display:inline;' onsubmit='event.preventDefault(); confirmDelete(this);'>
