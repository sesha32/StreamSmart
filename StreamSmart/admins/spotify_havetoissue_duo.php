...
<body>
    ...
    <div class="container">
        <h1>Spotify Subscriptions - Duo Plan</h1>
        <?php
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <form action='delete_spoduosubscription.php' method='POST' style='display:inline;' onsubmit='event.preventDefault(); confirmDelete(this);'>
