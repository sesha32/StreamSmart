...
<body>
    ...
    <div class="container">
        <h1>Hotstar Subscriptions - Monthly Plan</h1>
        <?php
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <form action='delete_hotmonsubscription.php' method='POST' style='display:inline;' onsubmit='event.preventDefault(); confirmDelete(this);'>
