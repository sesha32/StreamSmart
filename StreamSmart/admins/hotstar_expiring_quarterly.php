...
<head>
    ...
    <title>Expiring Soon - Quarterly Plan (Hotstar)</title>
    <style>
        ...
        .back-button {
            ...
            font-size: 1rem;
            color: #FFF;
            background-color: #00AEEF; /* Hotstar blue */
            border: none;
            border-radius: 5px;
            cursor: pointer;
        ...
        tr:nth-child(even) {
            background-color: #3A3A3A; /* Even row color */
        }
        tr:nth-child(odd) {
...
<body>
    ...
    <div class="container">
        <h1>Expiring Soon - Quarterly Plan (Hotstar)</h1>
