...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO hotstar_subscriptions (user_id, first_name, middle_name, last_name, email, mobile, plan) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="container">
        <?php if ($subscriptionSuccessful): ?>
            ...
            <p>This Hotstar plan may require a team setup to comeplete the plan, and we will notify you once everything is set. Please wait patiently. We will contact you via the mobile number you provided.</p>
